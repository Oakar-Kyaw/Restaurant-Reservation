                    ...
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                ...
                                @auth
                                <a href="{{url('/viewcart',$user_id)}}">
                                  Cart <span style="border-radius:5px;background-color:#21B7B7;padding:2px 8px 2px 8px;color:white;">{{$count}}</span> 
                                </a>
                                @endauth
                                @guest
                                <a href="{{url('/viewcart/0')}}">
                                  Cart
                                </a>
                                @endguest
